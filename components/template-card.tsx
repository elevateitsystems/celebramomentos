...
import { RootState, setFrame, setMessage, setPhotoSlots, setTemplate } from "@/lib/store";
import { MagazineFront, magazineHeadline } from "./magazine-card";
