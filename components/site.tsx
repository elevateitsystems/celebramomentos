...
export function SiteHeader({ active = "" }: { active?: string }) {
  ...
  const links = language === "es"
    ? [["Tienda", "/#categories"], ["Tarjetas", "/templates"], ["Cómo funciona", "/#how"], ["Nosotros", "/#story"], ["Ayuda", "/contact"]]
    : [["Loja", "/#categories"], ["Cartões", "/templates"], ["Como funciona", "/#how"], ["Sobre nós", "/#story"], ["Ajuda", "/contact"]];
  return <>
...
export function SiteFooter() {
  return <footer id="footer" className="border-t border-[#ebdfd6] bg-white py-12"><div className="container grid gap-10 md:grid-cols-[1.45fr_1fr_1fr] md:gap-16"><div><div className="flex items-center gap-3"><img src="/images/logo.png" alt="Celebra Momentos" className="h-14 w-14 object-contain" /><span className="text-[16px] font-black tracking-[-.03em]">Celebra<br /><span className="text-[#ee5264]">Momentos</span></span></div><p className="mt-5 max-w-[320px] text-sm leading-6 text-[#737b90]">Fotos que se convierten en detalles para regalar, compartir y recordar.</p></div><div><p className="text-xs font-black uppercase tracking-[.15em] text-[#182443]">Productos</p><div className="mt-5 grid grid-cols-2 gap-3 text-sm text-[#737b90] md:grid-cols-1"><Link href="/templates" className="hover:text-[#ee5264]">Tarjetas</Link><Link href="/calendars" className="hover:text-[#ee5264]">Calendarios</Link><Link href="/wall-art" className="hover:text-[#ee5264]">Arte de pared</Link><Link href="/magnets" className="hover:text-[#ee5264]">Imanes</Link><Link href="/phone-cases" className="hover:text-[#ee5264]">Fundas de móvil</Link></div></div><div><p className="text-xs font-black uppercase tracking-[.15em] text-[#182443]">Información</p><div className="mt-5 flex flex-col gap-3 text-sm text-[#737b90]"><Link href="/#story" className="hover:text-[#ee5264]">Nosotros</Link><Link href="/privacy" className="hover:text-[#ee5264]">Privacidad</Link><Link href="/cookies" className="hover:text-[#ee5264]">Cookies</Link><Link href="/terms" className="hover:text-[#ee5264]">Términos</Link><Link href="/contact" className="hover:text-[#ee5264]">Contacto</Link></div></div></div><div className="container mt-10 flex flex-col gap-3 border-t border-[#ebdfd6] pt-5 text-xs text-[#9297a4] sm:flex-row sm:items-center sm:justify-between"><span>© 2026 Celebra Momentos</span><span className="flex items-center gap-2"><Icon name="lock" size={13} /> Compra sencilla · Atención humana</span></div></footer>;
}
