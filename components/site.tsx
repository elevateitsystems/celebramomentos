...
export function SiteHeader({ active = "" }: { active?: string }) {
  ...
  const links = language === "es"
    ? [["Inicio", "/"], ["Productos", "/#categories"], ["Tarjetas", "/templates"], ["Cómo funciona", "/#how"], ["Ayuda", "/contact"]]
    : [["Início", "/"], ["Produtos", "/#categories"], ["Cartões", "/templates"], ["Como funciona", "/#how"], ["Ajuda", "/contact"]];
  return <>
