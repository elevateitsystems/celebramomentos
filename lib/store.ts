...
const initialState: CartState = {
  card: {
    ...
    frameId: null,
    message: "¡Atención! Hoy se celebra en todo el país el primer gol de temporada de Roberto García!",
    frontHeadline: "¡Atención! Hoy se celebra en todo el país el primer gol de temporada de Roberto García!",
    frontSubheadline: "Roberto García del equipo de Los Salesianos ha metido gol a los de Escolapios!",
    insideLeftText: "Tus abuelos, tu hermana, papá, mamá y Rocky te queremos mucho.",
    insideRightText: "¡Sigue así campeón!!",
    backText: "Una tarjeta creada especialmente para alguien especial.",
    emoji: "🎂",
    emojiTone: "natural",
    emojiSize: 32,
